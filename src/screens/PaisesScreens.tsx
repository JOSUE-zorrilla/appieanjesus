                  ...
                  renderItem={({ item }) => (
                    <View style={styles.cityCard}>
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        <Text style={styles.gps}>📍 {item.latitude}, {item.longitude}</Text>
                      </View>
                    </View>
                  )}
                />
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#002C73', alignItems: 'center', justifyContent: 'center', paddingVertical: 50 },
  headerTitle: { color: 'white', fontSize: 20, fontWeight: 'bold', marginTop: 30 },
  container: { padding: 16 },
  card: { backgroundColor: '#f5f7fa', flexDirection: 'row', alignItems: 'center', marginBottom: 12, padding: 12, borderRadius: 12, elevation: 3 },
  ...
  modalContent: { backgroundColor: 'white', width: '90%', maxHeight: '80%', borderRadius: 10, padding: 15 },
  modalTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 10, color: '#002C73', textAlign: 'center' },
  cityCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f5f5f5', marginBottom: 10, padding: 10, borderRadius: 8 },
  cityImage: { width: 60, height: 60, borderRadius: 8, marginRight: 10 },
  link: { color: '#25D366', fontWeight: 'bold', marginTop: 4 },
  gps: { fontSize: 12, color: '#555', marginTop: 2 },
  closeButton: { backgroundColor: '#002C73', paddingVertical: 10, alignItems: 'center', borderRadius: 8, marginTop: 10 },
});
